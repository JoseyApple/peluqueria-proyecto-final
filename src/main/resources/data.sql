...
('Corte de Cabello', 'Corte personalizado según el estilo del cliente', 30, 15.00),
('Coloración', 'Aplicación de tintes o mechas para cambiar el color del cabello', 90, 45.00),
('Peinados', 'Peinados para ocasiones especiales o uso diario', 45, 20.00),
('Tratamientos Capilares', 'Tratamientos nutritivos y reparadores para el cabello', 60, 35.00),
('Barbería', 'Servicios de afeitado, arreglo de barba y corte masculino', 40, 18.00),
('Tratamiento Facial', 'Limpieza profunda y revitalización del rostro', 50, 30.00);
